...
public class HomeActivity extends AppCompatActivity {
    ...
    private void banasree() {
        ...
        dbRef2 = FirebaseDatabase.getInstance().getReference().child("Servitors").child("Home Service").child("Banasree");
        ...
        dbRef2.addValueEventListener(new ValueEventListener(){
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(!dataSnapshot.exists()){
                    ...
                    banasree.setLayoutManager(new LinearLayoutManager(HomeActivity.this));
                    adapter=new ServitorsAdapter(list3,HomeActivity.this);
                    banasree.setAdapter(adapter);

                    Toast.makeText( HomeActivity. this,"Banasree Area", Toast.LENGTH_SHORT).show();
                }
    ...
    private void motijheel() {
        ...
        dbRef2 = FirebaseDatabase.getInstance().getReference().child("Servitors").child("Home Service").child("Motijheel");
        ...
        dbRef2.addValueEventListener(new ValueEventListener(){
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(!dataSnapshot.exists()){
                    ...
                    motijheel.setLayoutManager(new LinearLayoutManager(HomeActivity.this));
                    adapter=new ServitorsAdapter(list1,HomeActivity.this);
    ...
    private void banani() {
        ...
        dbRef2 = FirebaseDatabase.getInstance().getReference().child("Servitors").child("Home Service").child("Banani");
        ...
        dbRef2.addValueEventListener(new ValueEventListener(){
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(!dataSnapshot.exists()){
                    ...
                    banani.setLayoutManager(new LinearLayoutManager(HomeActivity.this));
                    adapter=new ServitorsAdapter(list2,HomeActivity.this);
   ...
   private void uttora() {
        ...
        dbRef2 = FirebaseDatabase.getInstance().getReference().child("Servitors").child("Home Service").child("Uttora");
        ...
        dbRef2.addValueEventListener(new ValueEventListener(){
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(!dataSnapshot.exists()){
                    ...
                    uttora.setLayoutManager(new LinearLayoutManager(HomeActivity.this));
                    adapter=new ServitorsAdapter(list4,HomeActivity.this);
    ...
    private void badda() {
        dbRef = reference.child("Home Service");
        //dbRef = reference.child("Banasree");
        dbRef2 = FirebaseDatabase.getInstance().getReference().child("Servitors").child("Home Service").child("Badda");
        //dbRef2 = dbRef.child("Banasree");
        ...
        dbRef2.addValueEventListener(new ValueEventListener(){
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(!dataSnapshot.exists()){
                    ...
                    badda.setLayoutManager(new LinearLayoutManager(HomeActivity.this));
                    adapter=new ServitorsAdapter(list5,HomeActivity.this);
    ...
    private void mogbazar() {
        dbRef = reference.child("Home Service");
        dbRef2 = FirebaseDatabase.getInstance().getReference().child("Servitors").child("Home Service").child("Mogbazar");
        ...
        dbRef2.addValueEventListener(new ValueEventListener(){
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(!dataSnapshot.exists()){
                    ...
                    Mog.setLayoutManager(new LinearLayoutManager(HomeActivity.this));
                    adapter=new ServitorsAdapter(list6,HomeActivity.this);
    ...
    private void malibaag() {
        dbRef = reference.child("Home Service");
        dbRef2 = FirebaseDatabase.getInstance().getReference().child("Servitors").child("Home Service").child("Malibaag");
        ...
        dbRef2.addValueEventListener(new ValueEventListener(){
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(!dataSnapshot.exists()){
                    ...
                    Mali.setLayoutManager(new LinearLayoutManager(HomeActivity.this));
                    adapter=new ServitorsAdapter(list7,HomeActivity.this);
    ...
    private void mirpur() {
        dbRef = reference.child("Home Service");
        dbRef2 = FirebaseDatabase.getInstance().getReference().child("Servitors").child("Home Service").child("Mirpur");
        ...
        dbRef2.addValueEventListener(new ValueEventListener(){
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(!dataSnapshot.exists()){
                    ...
                    Mir.setLayoutManager(new LinearLayoutManager(HomeActivity.this));
                    adapter=new ServitorsAdapter(list8,HomeActivity.this);
    ...
    private void mohammadpur() {
        dbRef = reference.child("Home Service");
        dbRef2 = FirebaseDatabase.getInstance().getReference().child("Servitors").child("Home Service").child("Mohammadpur");
        ...
        dbRef2.addValueEventListener(new ValueEventListener(){
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(!dataSnapshot.exists()){
                    ...
                    Pur.setLayoutManager(new LinearLayoutManager(HomeActivity.this));
                    adapter=new ServitorsAdapter(list9,HomeActivity.this);
    ...
    private void mohakhali() {
        dbRef = reference.child("Home Service");
        dbRef2 = FirebaseDatabase.getInstance().getReference().child("Servitors").child("Home Service").child("Mohakhali");
        ...
        dbRef2.addValueEventListener(new ValueEventListener(){
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(!dataSnapshot.exists()){
                    ...
                    Moha.setLayoutManager(new LinearLayoutManager(HomeActivity.this));
                    adapter=new ServitorsAdapter(list10,HomeActivity.this);
    ...
    private void tejgaon() {
        dbRef = reference.child("Home Service");
        dbRef2 = FirebaseDatabase.getInstance().getReference().child("Servitors").child("Home Service").child("Tejgaon");
        ...
        dbRef2.addValueEventListener(new ValueEventListener(){
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(!dataSnapshot.exists()){
                    ...
                    Tej.setLayoutManager(new LinearLayoutManager(HomeActivity.this));
                    adapter=new ServitorsAdapter(list11,HomeActivity.this);
    ...
    private void jatrabari() {
        dbRef = reference.child("Home Service");
        dbRef2 = FirebaseDatabase.getInstance().getReference().child("Servitors").child("Home Service").child("Jatranari");
        ...
        dbRef2.addValueEventListener(new ValueEventListener(){
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(!dataSnapshot.exists()){
                    ...
                    Jatra.setLayoutManager(new LinearLayoutManager(HomeActivity.this));
                    adapter=new ServitorsAdapter(list12,HomeActivity.this);
